...
export const WhyItWorks = () => {
  return (
    <div className="box-border content-stretch flex flex-col gap-6 md:gap-10 items-center justify-center px-6 md:px-10 py-0 relative w-full">
      {/* Background */}
      <div className="absolute bg-[#f5fcfa] h-[200px] md:h-[355px] left-0 top-[200px] md:top-[536px] w-full -z-10" />
      ...
      <div className="box-border content-stretch flex flex-col gap-10 md:gap-14 items-center justify-center pt-16 md:pt-32 px-0 relative shrink-0 w-full max-w-[1400px]">
        ...
        <div className="box-border content-stretch flex flex-col gap-6 md:gap-10 items-center justify-start p-0 relative shrink-0 w-full">
          <div className="font-['Epilogue:Bold',_sans-serif] font-bold relative shrink-0 text-[#274348] text-3xl md:text-[48px] text-center tracking-tight md:tracking-[-0.48px] w-full max-w-[1240px]">
            <p className="block leading-normal">Why Slimvera Works</p>
          </div>

          <div className="font-['DM_Sans:Regular',_sans-serif] font-normal relative shrink-0 text-[#274348] text-sm md:text-[16px] text-center w-full max-w-[720px]">
          ...
          <Link
            href="/products"
            className="box-border content-stretch flex flex-row gap-3 items-center justify-center pl-6 md:pl-8 pr-4 md:pr-6 py-3 md:py-4 relative rounded-[999px] shrink-0 cursor-pointer hover:bg-[#274348] hover:text-white transition-all duration-200 border border-[#274348] border-solid group"
          >
            <div className="box-border content-stretch flex flex-row gap-2 h-6 items-center justify-center px-0 py-[0.5px] relative shrink-0">
              <div className="flex flex-col font-['DM_Sans:Bold',_sans-serif] font-bold justify-center relative shrink-0 text-[#274348] text-sm md:text-[16px] text-left text-nowrap tracking-tight md:tracking-[-0.16px] uppercase group-hover:text-white transition-colors duration-200">
        ...
        {/* Illustration */}
        <div
          className="bg-center bg-contain bg-no-repeat h-[300px] md:h-[430px] mix-blend-darken shrink-0 w-full max-w-[800px] md:w-[1000px]"
          style={{
